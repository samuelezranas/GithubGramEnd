...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "API_KEY", "\"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\"")
...
dependencies {
    ...
    // ViewPager2 for swipe-based UI navigation
    ...
    ksp("androidx.room:room-compiler:2.5.2") // Room compiler for generating database access code
}
